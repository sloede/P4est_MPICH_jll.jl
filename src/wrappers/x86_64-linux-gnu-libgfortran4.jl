# Autogenerated wrapper script for P4est_MPICH_jll for x86_64-linux-gnu-libgfortran4
...
"""
function __init__()
    global artifact_dir = abspath(artifact"P4est_MPICH")
    ...
    foreach(p -> append!(PATH_list, p), (Zlib_jll.PATH_list, MPICH_jll.PATH_list, CompilerSupportLibraries_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (Zlib_jll.LIBPATH_list, MPICH_jll.LIBPATH_list, CompilerSupportLibraries_jll.LIBPATH_list,))
