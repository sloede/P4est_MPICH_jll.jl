...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import P4est_MPICH_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4152f6dd-c906-551a-895a-1735b697ea97"))
platforms = [Pkg.Artifacts.unpack_platform(e, "P4est_MPICH", artifacts_toml) for e in artifacts["P4est_MPICH"]]
...
if best_platform === nothing
    @debug("Unable to load P4est_MPICH; unsupported platform $(triplet(platform_key_abi()))")
else
